/* ============================================================================
   cysa+  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating CYSAPLUS.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (cysaplus.flash.v1) keyed by card id,
...
(function () {
  ...
  var DECK_SIZE = 100;
  /* Domain ids from metadata so deck logic tracks the real domain count (4 for CySA+). */
  ...
  function ver() { return window.CYSAPLUS_VER ? "?v=" + window.CYSAPLUS_VER : ""; }
  ...
  window.FLASH = {
    ...
    analytics: function () {
      ...
      var byD = {}; for (var _i = 0; _i < DOMS.length; _i++) { var n = DOMS[_i]; byD[n] = { total: DECK_SIZE, studied: 0, mastered: 0, due: this.domainDue(n) }; }
      for (var id in st) {
